...
///Inicializar la matriz a partir de las diferentes probabilidades dadas
    ...
    #pragma omp parallel for private(i) num_threads(20)
    ...
    #pragma omp parallel for  private(i,random) num_threads(20)
...
#pragma omp parallel for  private(indice, susceptibilidad, porcentajeEnfermos, probabilidadContagio, probHeridas, arbolesContagiando, vecinosVisitados) num_threads(20)
