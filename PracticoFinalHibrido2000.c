...
int main(int argc, char **argv) {
	...
	#pragma omp parallel for private(ejecuciones) num_threads(10)
...
MPI_Scatter(matrizCampo,(filasXproceso*sizeof(arbol)),MPI_BYTE, matrizLocal,filasXproceso*sizeof(arbol), MPI_BYTE, 0, MPI_COMM_WORLD);
    ...
    for(int semana =0; semana < cantSemanas; semana++){
        ...
        #pragma omp parallel for private(indice,indiceAbajoB, susceptibilidad, porcentajeEnfermos, probabilidadContagio, probHeridas, arbolesContagiando, vecinosVisitados) num_threads(10)
